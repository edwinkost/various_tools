...
def main():
    ...
    # identify the biggest island for every group of small islands within the windows 5x5 arcdeg cells
    large_island_map  = pcr.ifthen(pcr.scalar(island_map) == pcr.windowminimum(pcr.scalar(island_map), 5.), island_map)
