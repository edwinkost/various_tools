...
outp_folder = "/scratch-shared/edwin/aqueduct_irrigation_water_use/historical/1958-2001_watch/"
...
for i_year in range(0, len(start_years)):
    ...
    for year in range(sta_year, end_year + 1):
        ...
        #~ -rw-r--r-- 1 edwinsut aqueduct  41K Dec  1  2018 irrGrossDemand_annuaTot_output.nc
        #~ -rw-r--r-- 1 edwinsut aqueduct  41K Dec  1  2018 irrigationWaterWithdrawal_annuaTot_output.nc
        #~ -rw-r--r-- 1 edwinsut aqueduct 246K Dec  1  2018 irrGrossDemand_monthTot_output.nc
        ...
        cmd = "python merge_netcdf.py " + \
              ...
              "evaporation_from_irrigation,precipitation NETCDF4 True 1 Global"
        print(cmd)
        os.system(cmd)
        ...
        cmd = "python merge_netcdf.py " + \
              ...
              "irrNonPaddyWaterWithdrawal,irrPaddyWaterWithdrawal,directRunoff NETCDF4 True 1 Global"
        print(cmd)
        os.system(cmd)
