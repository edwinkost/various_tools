...
MONTHLY_OUTPUT_RETURN_FLOW_FILE="return_flow_from_industry_water_withdrawals_monthly_1990-2015.nc"
...
cdo -L -selyear,1990/2015 -setunit,m.month-1 -setname,"industry_return_flow" -mul -shifttime,-1day -shifttime,1month ${RETURN_FLOW_FRACTION_FILE} ${OUTPUT_WITHDRAWAL_FILE} ${MONTHLY_OUTPUT_RETURN_FLOW_FILE}
...
ANNUAL_OUTPUT_RETURN_FLOW_FILE="return_flow_from_industry_water_withdrawals_annual_1990-2015.nc"
