...
cdo -L -mergetime ${SOURCE_FOLDER}/global/netcdf/discharge_dailyTot_output_*.nc ${TARGET_FOLDER}/temp.nc
cdo -L -selyear,${STA_YEAR}/${END_YEAR} ${TARGET_FOLDER}/temp.nc ${TARGET_FOLDER}/discharge_dailyTot_output_${STA_YEAR}-01-01_to_${END_YEAR}-12-31.nc
