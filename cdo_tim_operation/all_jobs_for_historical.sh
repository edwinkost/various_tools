...
bash all_jobs_flexible_template.sh hisg historical gfdl-esm2m     ${MAIN_INP_FOLDER}/1951-2005/gfdl-esm2m/     ${MAIN_OUT_FOLDER}/1951-2005/gfdl-esm2m/     1951 2005
bash all_jobs_flexible_template.sh hish historical hadgem2-es     ${MAIN_INP_FOLDER}/1951-2005/hadgem2-es/     ${MAIN_OUT_FOLDER}/1951-2005/hadgem2-es/     1951 2005
bash all_jobs_flexible_template.sh hisi historical ipsl-cm5a-lr   ${MAIN_INP_FOLDER}/1951-2005/ipsl-cm5a-lr/   ${MAIN_OUT_FOLDER}/1951-2005/ipsl-cm5a-lr/   1951 2005
bash all_jobs_flexible_template.sh hism historical miroc-esm-chem ${MAIN_INP_FOLDER}/1951-2005/miroc-esm-chem/ ${MAIN_OUT_FOLDER}/1951-2005/miroc-esm-chem/ 1951 2005
bash all_jobs_flexible_template.sh hisn historical noresm1-m      ${MAIN_INP_FOLDER}/1951-2005/noresm1-m/      ${MAIN_OUT_FOLDER}/1951-2005/noresm1-m/      1951 2005
