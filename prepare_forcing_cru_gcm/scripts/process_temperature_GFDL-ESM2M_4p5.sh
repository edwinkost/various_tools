set -x 
rm -rf /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp4p5/GFDL-ESM2M/temperature//* 
mkdir -p /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp4p5/GFDL-ESM2M/temperature/ 
cd /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp4p5/GFDL-ESM2M/temperature/ 
...
cdo -L -f nc4 -ymonmean -seldate,1961-01-01,1990-12-31 /projects/0/dfguu/data/hydroworld/forcing/CMIP5/ISI-MIP-INPUT/GFDL-ESM2M/tas_bced_1960-1999_gfdl-esm2m_historical_1951-2005.nc temperature_gcm_reference.nc 
cdo -L -f nc4 -monmean /projects/0/dfguu/data/hydroworld/forcing/CMIP5/ISI-MIP-INPUT/GFDL-ESM2M/tas_bced_1960-1999_gfdl-esm2m_4p5_2006-2099.nc temp.nc
...
cdo -L -f nc4 -monadd /projects/0/dfguu/users/rens/data/GLO/forcing/CRU-TS3.23_ERA20C_GLO_daily_temperature_2011_to_2100.nc temperature_ano.nc /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp4p5/GFDL-ESM2M/temperature//CRU-TS3.23_ERA20C_GLO_daily_temperature_2011_to_2100_GFDL-ESM2M_rcp4p5.nc
