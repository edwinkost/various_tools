set -x 
rm -rf /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp6p0/IPSL-CM5A-LR/referencePotET//* 
mkdir -p /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp6p0/IPSL-CM5A-LR/referencePotET/ 
cd /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp6p0/IPSL-CM5A-LR/referencePotET/ 
...
rm temp.nc
rm temp2.nc
cdo -L -f nc4 -ymonmean -seldate,1961-01-01,1990-12-31 /projects/0/dfguu/data/hydroworld/forcing/CMIP5/ISI-MIP-INPUT/IPSL-CM5A-LR/epot_bced_1960_1999_ipsl-cm5a-lr_hist_1951-2005.nc referencePotET_gcm_reference.nc 
cdo -L -f nc4 -monmean /projects/0/dfguu/data/hydroworld/forcing/CMIP5/ISI-MIP-INPUT/IPSL-CM5A-LR/epot_bced_1960_1999_ipsl-cm5a-lr_6p0_2006-2099.nc temp.nc
...
cdo -L -f nc4 -monmul /projects/0/dfguu/users/rens/data/GLO/forcing/CRU-TS3.23_ERA20C_GLO_daily_referencePotET_2011_to_2100.nc referencePotET_ano.nc /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp6p0/IPSL-CM5A-LR/referencePotET//CRU-TS3.23_ERA20C_GLO_daily_referencePotET_2011_to_2100_IPSL-CM5A-LR_rcp6p0.nc
