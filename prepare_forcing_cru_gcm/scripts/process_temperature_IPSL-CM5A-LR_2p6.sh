set -x 
rm -rf /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp2p6/IPSL-CM5A-LR/temperature//* 
mkdir -p /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp2p6/IPSL-CM5A-LR/temperature/ 
cd /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp2p6/IPSL-CM5A-LR/temperature/ 
...
cdo -L -f nc4 -monmean /projects/0/dfguu/data/hydroworld/forcing/CMIP5/ISI-MIP-INPUT/IPSL-CM5A-LR/tas_bced_1960-1999_ipsl-cm5a-lr_2p6_2006-2099.nc temp.nc
...
cdo -L -f nc4 -monadd /projects/0/dfguu/users/rens/data/GLO/forcing/CRU-TS3.23_ERA20C_GLO_daily_temperature_2011_to_2100.nc temperature_ano.nc /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp2p6/IPSL-CM5A-LR/temperature//CRU-TS3.23_ERA20C_GLO_daily_temperature_2011_to_2100_IPSL-CM5A-LR_rcp2p6.nc
