set -x 
rm -rf /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp2p6/HadGEM2-ES/precipitation//* 
mkdir -p /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp2p6/HadGEM2-ES/precipitation/ 
cd /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp2p6/HadGEM2-ES/precipitation/ 
...
rm temp.nc
rm temp2.nc
cdo -L -f nc4 -ymonmean -seldate,1961-01-01,1990-12-31 /projects/0/dfguu/data/hydroworld/forcing/CMIP5/ISI-MIP-INPUT/HadGEM2-ES/pr_bced_1960-1999_hadgem2-es_historical_1951-2005.nc precipitation_gcm_reference.nc 
cdo -L -f nc4 -monmean /projects/0/dfguu/data/hydroworld/forcing/CMIP5/ISI-MIP-INPUT/HadGEM2-ES/pr_bced_1960-1999_hadgem2-es_2p6_2006-2099.nc temp.nc
...
cdo -L -f nc4 -monmul /projects/0/dfguu/users/rens/data/GLO/forcing/CRU-TS3.23_ERA20C_GLO_daily_precipitation_2011_to_2100.nc precipitation_ano.nc /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp2p6/HadGEM2-ES/precipitation//CRU-TS3.23_ERA20C_GLO_daily_precipitation_2011_to_2100_HadGEM2-ES_rcp2p6.nc
