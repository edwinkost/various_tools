set -x 
rm -rf /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp6p0/MIROC-ESM-CHEM/temperature//* 
mkdir -p /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp6p0/MIROC-ESM-CHEM/temperature/ 
cd /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp6p0/MIROC-ESM-CHEM/temperature/ 
...
cdo -L -f nc4 -ymonmean -seldate,1961-01-01,1990-12-31 /projects/0/dfguu/data/hydroworld/forcing/CMIP5/ISI-MIP-INPUT/MIROC-ESM-CHEM/tas_bced_1960-1999_miroc-esm-chem_historical_1951-2005.nc temperature_gcm_reference.nc 
cdo -L -f nc4 -monmean /projects/0/dfguu/data/hydroworld/forcing/CMIP5/ISI-MIP-INPUT/MIROC-ESM-CHEM/tas_bced_1960-1999_miroc-esm-chem_6p0_2006-2099.nc temp.nc
...
cdo -L -f nc4 -monadd /projects/0/dfguu/users/rens/data/GLO/forcing/CRU-TS3.23_ERA20C_GLO_daily_temperature_2011_to_2100.nc temperature_ano.nc /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp6p0/MIROC-ESM-CHEM/temperature//CRU-TS3.23_ERA20C_GLO_daily_temperature_2011_to_2100_MIROC-ESM-CHEM_rcp6p0.nc
