set -x 
rm -rf /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp8p5/GFDL-ESM2M/precipitation//* 
mkdir -p /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp8p5/GFDL-ESM2M/precipitation/ 
cd /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp8p5/GFDL-ESM2M/precipitation/ 
...
cdo -L -f nc4 -monmean /projects/0/dfguu/data/hydroworld/forcing/CMIP5/ISI-MIP-INPUT/GFDL-ESM2M/pr_bced_1960-1999_gfdl-esm2m_8p5_2006-2099.nc temp.nc
...
cdo -L -f nc4 -monmul /projects/0/dfguu/users/rens/data/GLO/forcing/CRU-TS3.23_ERA20C_GLO_daily_precipitation_2011_to_2100.nc precipitation_ano.nc /scratch-shared/edwinhs/forcing_ISI-MIP_CRU-TS3.23_ERA20C/rcp8p5/GFDL-ESM2M/precipitation//CRU-TS3.23_ERA20C_GLO_daily_precipitation_2011_to_2100_GFDL-ESM2M_rcp8p5.nc
