...
INP_FILENAME=${SOURCE_FOLDER}/${FILENAME}

# mergegrid
TMP_PRE_FILENAME="tmp_pre_"${FILENAME}
mv ${MAIN_OUTPUT_FOLDER}/${TMP_OUT_FILENAME} ${MAIN_OUTPUT_FOLDER}/${TMP_PRE_FILENAME}
cdo -L -mergegrid ${MAIN_OUTPUT_FOLDER}/${TMP_PRE_FILENAME} -remapnn,${CLONE_FILE} ${INP_FILENAME} ${MAIN_OUTPUT_FOLDER}/${TMP_OUT_FILENAME}
